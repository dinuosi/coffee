			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input type="text" name="shangjiashijian" id="shangjiashijian" autocomplete="off" class="layui-input" >
						</div>
					</div>
		            <div class="layui-form-item" pane>
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="shangpinmiaoshu" id="shangpinmiaoshu">请输入商品描述</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
                                ...
                                jquery('#shangjiashijian').val(getCurDate());
				laydate.render({
					elem: '#shangjiashijian'
				});
                var edit = tinymce.render({
                    elem: "#shangpinmiaoshu",
                    height: 600,
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='shangjiashijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.shangjiashijian = true;
                                                jquery('#shangjiashijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='shangpinmiaoshu'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.shangpinmiaoshu = true;
                                                continue;
                                        }
                                        if(o=='thumbsupnum'){
                                                vue.detail[o] = obj[o];
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					var shangpinmiaoshu = tinymce.get('#shangpinmiaoshu').getContent()
					data.shangpinmiaoshu = shangpinmiaoshu;
