						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="shangjiashijian" name="shangjiashijian" class="form-control" v-model="ruleForm.shangjiashijian" readonly>
									</div>
									...
									<div class="form-group  col-md-12">
										<label>商品描述</label>
										<script id="shangpinmiaoshuEditor" type="text/plain" style="width:800px;height:230px;"></script>
	...
	<script>
		...
		function setContent(){
			if(ruleForm.shangpinmiaoshu != null && ruleForm.shangpinmiaoshu != 'null' && ruleForm.shangpinmiaoshu != ''){
				var mes = '' + ruleForm.shangpinmiaoshu;
				var shangpinmiaoshuUeditor = UE.getEditor('shangpinmiaoshuEditor');
				shangpinmiaoshuUeditor.ready(function() {
					shangpinmiaoshuUeditor.setContent(mes);
					shangpinmiaoshuUeditor.setDisabled('fullscreen');
				});
			}
		}  
