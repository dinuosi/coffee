...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('shangjiashijian')">上架时间<i id="shangjiashijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var shangjiashijianCell  = document.createElement('td');

						  shangjiashijianCell.innerHTML = item.shangjiashijian;


			row.appendChild(shangjiashijianCell);
			var shangpinmiaoshuCell  = document.createElement('td');
